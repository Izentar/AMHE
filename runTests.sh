...
do
	...
	do
		...
		do
			...
			do
				# Run reference test
				python tests.py  --sigma $sigma --dim $dims --seed $seed --xstart $start_type --xsgm 0 --xsgstd $xstd --estart dull --esgm 0 --esgstd 1 --xsumin 0 --xsumax 1 --xsexpl 1 --testf $fun -r $reps -o $output_file.csv
			done
		done
		for dims in $(seq 5 5 10)
		do
			...
			do
				...
				python tests.py  --sigma $sigma --dim $dims --seed $seed --xstart $start_type --xsgm 0 --xsgstd $xstd --estart gauss --esgm 0 --esgstd $estd --xsumin 0 --xsumax 1 --xsexpl 0.1 --testf $fun -r $reps -o $output_file.csv
			done
		done
	done
done
